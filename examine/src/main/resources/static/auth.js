var Auth = {
	...
	forgot(e) {
		...
		Auth.vars.lowin_login.querySelector('form').setAttribute('action', Auth.vars.option.forgot_url).setAttribute("method","GET");
	...
	loginback(e) {
		...
		Auth.vars.lowin_login.querySelector('form').setAttribute('action', Auth.vars.option.login_url).setAttribute('method','POST');
